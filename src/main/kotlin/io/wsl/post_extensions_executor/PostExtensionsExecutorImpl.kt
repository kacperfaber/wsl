...
class PostExtensionsExecutorImpl(var beanProvider: BeanOrNullProvider) : PostExtensionsExecutor {
    ...
    override fun execute(onlyPostExtensions: List<ExtensionModel>, actionCall: ActionCall, result: Any?) {
        for (postExtension in onlyPostExtensions) {
            ...
            bean.afterInvoke(actionCall, result, postExtension.annotation)
        }
    }
}